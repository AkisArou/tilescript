...
use tilescript_core::resize::ResizeDirection;
use tilescript_core::wm::DrawableSpace;
use tilescript_layout_runtime as runtime_facade;

pub use abi::{
    TilescriptAction, TilescriptActionResult, TilescriptCommandInput, TilescriptDiagnostic,
    TilescriptDiagnosticRange, TilescriptLayoutStatusResult, TilescriptOutputSync,
    TilescriptPlacementGeometry, TilescriptPlacementResult, TilescriptStateResult, TilescriptStatusResult,
    TilescriptStringResult, TilescriptWindowSync, TilescriptWorkspaceLayoutSpaceSync,
};
...
use runtime_types::{TilescriptRuntimeHandle, LayoutRuntimeStatus, StatusResult};
use sdk::sync_sdk_support;

#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_new() -> *mut TilescriptRuntimeHandle {
    Box::into_raw(Box::new(TilescriptRuntimeHandle {
        model: tilescript_core::wm::WmModel::default(),
        layout_runtime: None,
    }))
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_free(handle: *mut TilescriptRuntimeHandle) {
    if handle.is_null() {
        return;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_dispatch_command(
    handle: *mut TilescriptRuntimeHandle,
    command: *const TilescriptCommandInput,
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_reset_state_result(
    handle: *mut TilescriptRuntimeHandle,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_upsert_output_result(
    handle: *mut TilescriptRuntimeHandle,
    output: *const TilescriptOutputSync,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
        if output.is_null() {
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_remove_output_result(
    handle: *mut TilescriptRuntimeHandle,
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_activate_workspace_result(
    handle: *mut TilescriptRuntimeHandle,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_set_workspace_layout_space_result(
    handle: *mut TilescriptRuntimeHandle,
    layout_space: *const TilescriptWorkspaceLayoutSpaceSync,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_focus_window_result(
    handle: *mut TilescriptRuntimeHandle,
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_set_window_closing_result(
    handle: *mut TilescriptRuntimeHandle,
    window_id: *const std::ffi::c_char,
    closing: bool,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
        let window_id = tilescript_core::WindowId::from(cstr_to_str(window_id)?.to_string());
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_remove_window_result(
    handle: *mut TilescriptRuntimeHandle,
    window_id: *const std::ffi::c_char,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_upsert_window_result(
    handle: *mut TilescriptRuntimeHandle,
    window: *const TilescriptWindowSync,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
        if window.is_null() {
        ...
        let window_id = tilescript_core::WindowId::from(cstr_to_str(window.window_id)?.to_string());
        let previous_focused_window_id =
            optional_cstr_to_string(window.previous_focused_window_id)?.map(tilescript_core::WindowId::from);
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_bootstrap_config_result(
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_sync_sdk_support_result(
    config_root: *const std::ffi::c_char,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
        let config_root = std::path::PathBuf::from(cstr_to_str(config_root)?);
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_load_layout_config_result(
    handle: *mut TilescriptRuntimeHandle,
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_reload_layout_config_result(
    handle: *mut TilescriptRuntimeHandle,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_poll_layout_sources_result(
    handle: *mut TilescriptRuntimeHandle,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_layout_source_change_fd(
    handle: *mut TilescriptRuntimeHandle,
) -> i32 {
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_layout_placement(
    handle: *mut TilescriptRuntimeHandle,
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(result)) => result,
        Ok(Err(_)) | Err(_) => {
            TilescriptPlacementResult { geometries: std::ptr::null_mut(), geometry_count: 0 }
        }
    }
}

#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_layout_placement_for_workspace(
    handle: *mut TilescriptRuntimeHandle,
    workspace_id: *const std::ffi::c_char,
) -> TilescriptPlacementResult {
    match catch_unwind(AssertUnwindSafe(|| {
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_layout_focus_candidate(
    handle: *mut TilescriptRuntimeHandle,
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(result)) => result,
        Ok(Err(_)) | Err(_) => TilescriptStringResult { value: std::ptr::null_mut() },
    }
}

#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_layout_close_focus_candidate(
    handle: *mut TilescriptRuntimeHandle,
    window_id: *const std::ffi::c_char,
) -> TilescriptStringResult {
    match catch_unwind(AssertUnwindSafe(|| {
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_layout_swap_candidate(
    handle: *mut TilescriptRuntimeHandle,
    direction: *const std::ffi::c_char,
) -> TilescriptStringResult {
    match catch_unwind(AssertUnwindSafe(|| {
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_move_tiled_window(
    handle: *mut TilescriptRuntimeHandle,
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        let handle = ffi_handle_mut(handle)?;
        let first_window_id =
            tilescript_core::WindowId::from(cstr_to_str(first_window_id)?.to_string());
        let second_window_id =
            tilescript_core::WindowId::from(cstr_to_str(second_window_id)?.to_string());
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_resize_direction(
    handle: *mut TilescriptRuntimeHandle,
    direction: *const std::ffi::c_char,
) -> TilescriptStatusResult {
    match catch_unwind(AssertUnwindSafe(|| {
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_state_result(
    handle: *mut TilescriptRuntimeHandle,
...
#[unsafe(no_mangle)]
pub extern "C" fn tilescript_runtime_layout_status_result(
    handle: *mut TilescriptRuntimeHandle,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_string_free(value: *mut std::ffi::c_char) {
    unsafe {
        string_free(value);
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_free_placement_result(result: TilescriptPlacementResult) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_free_action_result(result: TilescriptActionResult) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_free_state_result(result: TilescriptStateResult) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_free_layout_status_result(
    result: TilescriptLayoutStatusResult,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tilescript_runtime_free_status_result(result: TilescriptStatusResult) {
    if !result.focused_window_id.is_null() {
        unsafe {
            string_free(result.focused_window_id);
        }
...
fn ffi_handle_mut<'a>(
    handle: *mut TilescriptRuntimeHandle,
) -> Result<&'a mut TilescriptRuntimeHandle, FfiError> {
    if handle.is_null() {
        return Err(FfiError::NullPointer);
    }
...
) -> Result<Option<tilescript_core::WindowId>, FfiError> {
    optional_cstr_to_string(value).map(|value| value.map(tilescript_core::WindowId::from))
}

fn placement_result(
    entries: Vec<layout::PlacementGeometry>,
) -> Result<TilescriptPlacementResult, FfiError> {
    let geometries = entries
        .into_iter()
        .map(|entry| {
            Ok(TilescriptPlacementGeometry {
    ...
    Ok(TilescriptPlacementResult { geometries: geometries_ptr, geometry_count })
}

fn string_result(value: Option<String>) -> Result<TilescriptStringResult, FfiError> {
    let Some(value) = value else {
        return Ok(TilescriptStringResult { value: std::ptr::null_mut() });
    };

    Ok(TilescriptStringResult {
...
fn action_result(actions: Vec<HostAction>) -> Result<TilescriptActionResult, FfiError> {
    let actions = actions
        .into_iter()
        .map(action_to_ffi)
        .collect::<Result<Vec<TilescriptAction>, FfiError>>()?;
    ...
    Ok(TilescriptActionResult { actions: actions_ptr, action_count, error: std::ptr::null_mut() })
}

fn error_action_result(error: FfiError) -> TilescriptActionResult {
    let error = std::ffi::CString::new(error.to_string())
        .expect("ffi error strings must not contain nul bytes")
        .into_raw();

    TilescriptActionResult { actions: std::ptr::null_mut(), action_count: 0, error }
}

fn state_result(
    snapshot: tilescript_core::snapshot::StateSnapshot,
) -> Result<TilescriptStateResult, FfiError> {
    let workspace_name_count = snapshot.workspace_names.len();
    Ok(TilescriptStateResult {
...
fn diagnostic_array(
    diagnostics: Vec<tilescript_layout_runtime::LayoutDiagnostic>,
) -> Result<*mut TilescriptDiagnostic, FfiError> {
    let mut raw_diagnostics = diagnostics
        .into_iter()
        .map(|diagnostic| {
            Ok(TilescriptDiagnostic {
                ...
                range: TilescriptDiagnosticRange {
...
fn free_diagnostic_array(values: *mut TilescriptDiagnostic, count: usize) {
    if values.is_null() {
        return;
    }
...
fn empty_state_result() -> TilescriptStateResult {
    TilescriptStateResult {
...
fn empty_layout_status_result() -> TilescriptLayoutStatusResult {
    TilescriptLayoutStatusResult {
        loaded: false,
...
fn status_result(status: StatusResult) -> Result<TilescriptStatusResult, FfiError> {
    Ok(TilescriptStatusResult {
...
fn error_status_result(error: FfiError) -> TilescriptStatusResult {
    TilescriptStatusResult {
        changed: false,
        focused_window_id: std::ptr::null_mut(),
...
mod tests {
    use super::*;
    use tilescript_core::command::WmCommand;

    #[test]
    fn dispatch_command_returns_tilescript_actions() {
