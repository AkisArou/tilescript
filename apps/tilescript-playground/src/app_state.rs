...
const STORAGE_KEY: &str = "tilescript.playground.ui-state.v3";
...
pub struct AppState {
    ...
    pub loaded_config: RwSignal<Option<tilescript_config::model::Config>>,
}
...
impl AppState {
    ...
    pub fn apply_loaded_config(&self, config: tilescript_config::model::Config) {
