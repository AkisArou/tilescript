...
fn preview_canvas_rect(session: &PreviewSessionState) -> tilescript_core::LayoutRect {
    let layout_space = session
        ...
        .unwrap_or(tilescript_core::wm::DrawableSpace { width: 1240, height: 760 });

    tilescript_core::LayoutRect {
        x: 0.0,
        y: 0.0,
...
pub(super) struct PreviewWindowRenderState {
    ...
    pub(super) rect: tilescript_core::LayoutRect,
...
fn PreviewWindowFrame(state: PreviewWindowRenderState) -> impl IntoView {
    ...
    let previous_rect = StoredValue::new(None::<tilescript_core::LayoutRect>);
...
fn HtopWindow() -> impl IntoView {
    ...
    let process_rows = [
        (
            ...
            "4.6",
            "01:12.48",
            "cargo check -p tilescript-playground",
        ),
        (
            "2210",
            "akisarou",
            ...
            "3.1",
            "00:44.20",
            "trunk serve --config apps/tilescript-playground/Trunk.toml",
        ),
        (
            "0990",
            "akisarou",
            ...
            "1.8",
            "00:13.91",
            "nvim apps/tilescript-playground/src/views/preview/windows.rs",
        ),
        (
            "0431",
            "root",
