...
const monacoTheme = "tilescript-terminal";
const workspaceRootUri = "file:///home/demo/.config/tilescript";
...
function ensureMonacoStyles() {
  const styleId = "tilescript-monaco-host-css";
...
function ensureConfigured(extraLibs: MonacoExtraLib[]) {
  ...
  if (!configured) {
    ...
    monaco.typescript.typescriptDefaults.setCompilerOptions({
      ...
      paths: {
        "@tilescript/sdk": ["./node_modules/@tilescript/sdk/index.d.ts"],
        "@tilescript/sdk/*": ["./node_modules/@tilescript/sdk/*"],
      },
